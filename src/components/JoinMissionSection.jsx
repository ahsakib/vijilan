...
const JoinMissionSection = ({ title, highlightedText, subtitle, buttonText,url }) => {
  return (
    <section className="relative z-10 sm:px-4 md:px-0 py-16">
      <div className="container mx-auto ">
        <div
          className="h-auto md:h-[320px] flex flex-col items-center justify-center rounded-[24px] px-[8px] py-[24px] relative overflow-hidden"
          style={{
        ...
        >
          ...
          <div className="relative z-10 text-center ">
            ...
            <Link to={url? url : ""}>
              <button
                className="p-[16px] md:p-[24px] text-[16px] md:text-lg font-medium rounded-[8px] text-white inline-flex items-center space-x-3 transition hover:scale-105"
                style={{
