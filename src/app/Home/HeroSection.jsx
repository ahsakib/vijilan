  ...
  return (
    <section className="container mx-auto px-6 py-20 text-center relative z-10">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
            ...
            <span className="text-cyan-400">Cybersecurity.</span> Empowering MSP Growth.<br />
          ...
          <button className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white px-8 py-3 text-lg rounded flex items-center justify-center gap-2 mx-auto">
