    ...
    return (
        ...
        <div className=' container mx-auto px-2 sm:px-4 md:px-6 lg:px-8 xl:px-6'>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 items-start justify-between gap-10'>
                        ...
                        <div className='col-span-1  '>
                            <div className='mt-8 flex flex-col md:flex-row  gap-5'>
                                <button className='text-white bg-[#00AEEF] px-14 py-3 rounded-xl z-10  '>Modular Essentials</button>
                                <button className='text-gray-400 bg-white px-14 py-3 rounded-xl ml-0 md:-ml-8  '>User Based (Remote)</button>
                            </div>
            ...
            <div>
                ...
                <div className=" w-full max-w-3xl mx-auto flex flex-wrap justify-between gap-3 md:gap-5">
                    {tabs.map((tab, index) => (
                        <p
                            key={index}
