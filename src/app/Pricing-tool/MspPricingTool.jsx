        ...
        <div className='container mx-auto px-2 sm:px-4 md:px-6 lg:px-8 xl:px-6 '>
            <section className=" py-16">
                <div className="">
                    ...
                    <div className="text-center mb-12">
                        <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold mb-5'>Let's Connect</h1>
                        <p className='text-lg font-medium'>Whether you're interested in our services, want to become a partner, or need <br />support, our team is here to help. Reach out and let's start the conversation.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="bg-[#00AEEF3D] backdrop-blur-sm  rounded-2xl p-8 relative" >
                            ...
                            <div className='mt-12'>
                                <div className=" flex justify-center items-center mx-auto">
                                    <span className="bg-[#F1511B] text-white text-[10px] font-semibold px-[6px] py-[3px] rounded-[15px]">ADD ICON</span>
                                </div>
                                <div className="mt-5  ">
                                    <h3 className="text-2xl font-medium text-white mb-5 text-center">Sales & General Inquiries</h3>
                                    <p className="text-white  text-sm md:text-lg  mb-5 leading-relaxed">
                                    ...
                                    <div className="space-y-5 text-center">
                                        ...
                                        <p
                                            className="block text-[14px] font-bold underline" style={{ color: "#00AEEF" }}>
                                            sales@vijilan.com
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div className="bg-[#00AEEF3D] backdrop-blur-sm  rounded-2xl p-8 relative">
                            ...
                            <div className='mt-12'>
                                ...
                                <div className="mt-5">
                                    <h3 className="text-2xl font-medium text-white mb-5 text-center">Our Address</h3>
                                    <p className="text-white  text-sm md:text-lg  mb-5 leading-relaxed ">
                                        Visit us at our state-of-the-art facility in South Florida's technology corridor.
                                    </p>
                                    <div className="text-white text-[16px] space-y-1 text-center">
                        ...
                        <div className="bg-[#00AEEF3D] backdrop-blur-sm  rounded-2xl p-8 relative">
                            ...
                            <div className='mt-12'>
                                ...
                                <div className="mt-5">
                                    <h3 className="text-2xl font-medium text-white mb-5 text-center">Partner & Customer Support</h3>
                                    <p className="text-white  text-sm md:text-lg mb-5 leading-relaxed ">
                                    ...
                                    <div className="space-y-4 mb-5 text-center">
                                        ...
                                        <p
                                            className="block text-[14px] text-[#00AEEF] font-bold underline" style={{ color: "#00AEEF" }}>
                                            sales@vijilan.com
                                        </p>
                                    </div>
                                    <div className='border border-[#00AEEF] rounded-[7px] flex items-center justify-center w-fit mx-auto'>
                                        <button className="w-fit  text-white text-center px-[13px] py-[14px] ">
            ...
            <section className="py-16 relative overflow-hidden ">
                <div className="relative z-10 ">
                    ...
                    {/* Main Content */}
                    <div className="">
                        <div className="relative bg-[#00AEEF3D] backdrop-blur-sm rounded-3xl ">
                            <div
                            ...
                            <div className="mb-5 flex space-x-1 ml-auto bg-[#00AEEF3D] py-2 px-4 rounded-t-[24px] w-3/5">
                                <button
                                    className="flex-1 w-fit py-3 px-1 md:px-4 text-[10px] md:text-[16px] font-bold " style={{
                                ...
                                <button
                                    className="flex-1 py-3 px-1 md:px-4 rounded-md text-[10px] md:text-[16px] font-bold text-[#00AEEF] ">
                                    Become a partner
                                </button>
                                <button
                                    className="flex-1 py-3 px-1 md:px-4 rounded-md text-[10px] md:text-[16px] font-bold text-[#00AEEF]">
                            ...
                            <div className="relative z-10 lg:flex gap-8 space-y-10 lg:space-y-0 pb-10">
                                {/* Left Side - Contact Info */}
                                <div className="lg:w-2/5 flex flex-col justify-start pl-10">
                                    <div>
                                        <h2 className="text-2xl md:text-[32px] font-bold text-white mb-2">Get in Touch with the <br /> Right Team</h2>
                                ...
                                {/* Right Side - Form */}
                                <div className="lg:w-3/5  space-y-6  px-10 ">
                                    ...
                                    <div className=" relative z-10 grid grid-cols-2 gap-4">
                                        <select
                                            ...
                                            <option value="cybersecurity" className='text-black' style={{color: "black"}}>Cybersecurity</option>
                                            <option value="consulting" className='text-black' style={{color: "black"}}>Consulting</option>
                                            <option value="support" className='text-black' style={{color: "black"}}>Support</option>
                                        </select>
                                        <input
                                            type="text"
                                            name="company"
