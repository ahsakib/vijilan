...
const PricingTool = () => {
    ...
    return (
        <div className=''>
            ...
            <section className='-mx-4 pb-16 pt-10'>
                <div className="w-full h-auto md:h-[227px] p-5 flex justify-center items-center " style={{
                    background: "linear-gradient(0deg, #082235 53.83%, #00AEEF 328.5%)"
                }}>
                    <div className="container mx-auto sm:px-4 md:px-6 lg:px-8 xl:px-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-8" >
                        {/* Left content */}
                        ...
                        {/* Right button */}
                        <div className="lg:mr-[110px] border border-[#00AEEF] rounded-[8px]">
                            <button className="font-medium text-[16px] md:text-[18px] p-[18px] md:p-[24px]">
                                NEW QUOTE
                            </button>
                        </div>
                    </div>
            ...
            <section className="container mx-auto px-6 py-16">
                <div className="h-auto md:h-[304px] rounded-3xl p-5 md:p-12 w-full text-center" style={{
                    ...
                    <button className="bg-white !text-[#F1511B] font-bold text-[16px] px-4  md:w-[589px] py-4 rounded-[8px] ">
            ...
            {/* form section */}
            <div className="container mx-auto sm:px-4 md:px-6 lg:px-8 xl:px-6 py-20">
                <div className=" grid grid-cols-1 lg:grid-cols-5 gap-8">
                    {/* Left Column - Calculator Form */}
                    <div className="relative col-span-5 lg:col-span-3 bg-[#00AEEF3D] backdrop-blur-sm rounded-[24px] p-8 ">
                        <div
                        ...
                        />
                        <div className="mb-8">
                            <h1 className="text-[24px] font-medium text-white  z-10 mb-4 relative">Vijilan Pricing Calculator</h1>
                        ...
                        {/* Discount Button */}
                        <div className='w-fit flex items-center mx-auto border border-[#00AEEF] rounded-[8px]'>
                            <button className=" p-[18px] md:p-[24px] text-white font-medium text-[16px] md:text-[18px] transition-colors">
                    ...
                    <div className="col-span-5 lg:col-span-2 md:flex lg:flex-col gap-5 space-y-6">
                        ...
                        <div className="relative bg-[#00AEEF3D] backdrop-blur-sm rounded-[24px] p-8 ">
                            ...
                            />
                            <h2 className="text-[28px] text-center font-bold  mb-6" >Your Estimated Quote</h2>

                            <div className="mb-2">
                                <div className="flex justify-between items-center mb-4">
                                    <span className="text-white text-[21px] font-bold" style={{color: "#FFFFFF80"}}>SubTotal Monthly:</span>
                                    <span className="mr-3 text-[21px] !text-[#00AEEF]">{totals.subtotal}</span>
                                </div>

                                <div className="bg-[#567286] rounded-[11px] px-6 py-3 border border-[#00AEEF]">
                                    <div className="flex justify-between items-center">
                                        <span className="!text-[#00AEEF] text-[21px] font-bold">Total Monthly Cost:</span>
                                        <span className="!text-[#00AEEF] text-[21px] font-bold">{totals.totalMonthlyCost}</span>
                                    </div>
                                </div>
                            </div>

                            <div className="space-y-2">
                                <h3 className="text-[#F5F5F5] text-[21px] font-bold">Quote Actions</h3>

                                <button className="w-full text-start bg-[#567286] border border-[#00AEEF] rounded-[11px] px-7 py-3 !text-[#00AEEF] font-bold text-[21px] transition-colors">
                                    Save Quote as a PDF
                                </button>

                                <button className="w-full text-start bg-[#567286] border border-[#00AEEF] rounded-[11px] font-bold text-[21px] px-7 py-3 text-white ">
                                    Start a New Quote
                                </button>
                            </div>
                        </div>
                        ...
                        {/* Related Articles */}
                        <div className="relative lg:ml-10 bg-[#00AEEF3D] backdrop-blur-sm rounded-[24px] p-8 border border-[#FFFFFF20]">
                            <div
                                className="absolute inset-0 rounded-[26px] p-[2px] z-0"
                                style={{
                                    background: `linear-gradient(146.58deg, #00AEEF 0.86%, rgba(8,34,53,0) 50%), linear-gradient(326.95deg, #00AEEF 0.69%, rgba(8,34,53,0) 66.77%)`,
            ...
            {/*  */}
            <section className="container mx-auto px-2 sm:px-4 md:px-6 lg:px-8 xl:px-6 py-16" >
                <div className='rounded-[24px]' style={{
                    background: "linear-gradient(0deg, #082235 53.83%, #00AEEF 328.5%)"
                }}>
                    <div className="w-full ">
                        {/* Main container with dotted border */}
                        <div className=" rounded-lg py-[83px] px-5 md:px-[100px] lg:px-[140px] ">
                            {/* Header */}
                                ...
                                {tools.map((tool, index) => (
                                    <div
                                        ...
                                        <div className="text-center">
                                            <h3 className="text-[16px] font-mediium text-white mb-3 ">
                                                {tool.title}
                                            </h3>
                                            <p className="text-white text-[12px] leading-relaxed">{tool.description}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
