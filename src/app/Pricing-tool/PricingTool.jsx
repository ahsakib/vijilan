    ...
    return (
        <div className=''>
            ...
            <section className='py-16'>
                <div className="w-full h-[227px] flex justify-center items-center " style={{
            ...
            <section className="container mx-auto px-6 ">
                <div className="h-[304px] rounded-3xl p-12 w-full text-center" style={{
                    background: "linear-gradient(90deg, #F89B29 0%, #FF0F7B 186.51%)"
                }}>

                    <h2 className="text-white text-4xl md:text-[40px] font-bold mb-6">Ready to Make It Official?</h2>

                    <p className="text-white text-[16px] mb-8 font-medium leading-relaxed">
                        You've seen the pricing and the resources. The next step is to join our network of <br /> successful partners.
                    </p>

                    <button className="bg-white text-[#F1511B] font-bold text-[16px] px-8 py-4 rounded-[8px] ">
            ...
            <div className="container mx-auto px-6 py-20">
                <div className=" grid lg:grid-cols-2 gap-8">
                    ...
                    <div className="relative bg-[#00AEEF3D] backdrop-blur-sm rounded-[24px] p-8 ">
                        ...
                        />
                        <div className="mb-8">
                            <h1 className="text-[24px] font-medium text-white mb-4">Vijilan Pricing Calculator</h1>
                        ...
                        <div className="mb-8">
                            ...
                            <div className="mb-6">
                                <div className="flex justify-between items-center mb-3">
                                    <span className="text-white text-[16px] ">TRX Endpoint (EDR/XDR)</span>
                            ...
                            <div className="mb-6">
                                <div className="flex justify-between items-center mb-3">
                                    <span className="text-white text-[16px]">TRX Identity</span>
                            ...
                            <div className="mb-6">
                                <div className="flex justify-between items-center mb-3">
                                    <span className="text-white text-[16px] ">TRX Visibility (Exposure)</span>
                        ...
                        <div className="mb-8">
                            ...
                            <div className="mb-6">
                                <div className="flex justify-between items-center mb-3">
                                    <span className="text-white text-[16px] ">Critical Servers</span>
                            ...
                            <div className="mb-6">
                                <div className="flex justify-between items-center mb-3">
                                    <span className="text-white text-[16px]">Firewalls & Security Appliances</span>
                            ...
                            <div className="mb-6">
                                <div className="flex justify-between items-center mb-3">
                                    <span className="text-white text-[16px] ">Cloud Sources and Cloud Applications</span>
                                    <span className="text-[#00AEEF] text-[11px]">$99/appliance</span>
                                </div>
                                <div className="relative">
                                    <select
                        ...
                        {/* Discount Button */}
                        <div className='border border-[#00AEEF] rounded-[8px]'>
                            <button className="w-full  p-[16px] text-white font-medium text-[17px] transition-colors">
            ...
            <section className="container mx-auto px-6 py-16" >
                <div className='rounded-[24px]' style={{
                    ...
                    <div className="w-full ">
                        ...
                        <div className=" rounded-lg py-[83px] px-[140px] ">
                            {/* Header */}
