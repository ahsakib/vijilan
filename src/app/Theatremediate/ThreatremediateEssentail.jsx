    ...
    return (
        <div className=''>
            <section className='container mx-auto px-6 py-16 '>
                <div>
                    <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold text-center mb-5 leading-14'>ThreatRemediate Essentials: Flexible, Modular <br />  Security for Your Clients</h1>
                ...
                <Link to={"/pricing-tool"} onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
                    <div className='flex items-center justify-center mt-[60px]'>
                        <button className='uppercase font-medium text-[18px] p-[18px] md:p-[24px] rounded-[8px]' style={{
            ...
            <section className="container mx-auto px-2  sm:px-4 md:px-6 lg:px-8 xl:px-6 pb-16 " >
                <div className="py-[75px] px-5 md:px-[40px] lx:px-[78px] rounded-[24px]" style={{
                    background: "linear-gradient(0deg, #082235 53.83%, #00AEEF 328.5%)"
                }}>
                    {/* Main Container */}
                    <div className="relative bg-[#00AEEF3D] backdrop-blur-sm rounded-[24px] py-[50px] md:py-[78px] px-[15px] md:px-[38px]">
                        <div
                        ...
                        {/* Header Section */}
                        <div className="">
                            <h2 className="text-[22px] font-bold text-white mb-4">Why Choose a Modular Approach?</h2>
                            <p className="text-white text-lg leading-relaxed">
                                Not all clients need the same level of security, and a modular approach allows partners to tailor
                                solutions, optimize <br /> costs, and meet specific client requirements. Emphasize flexibility and scalability.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4   gap-3  m-2 lg:ml-8">
                            ...
                            <CardBorder height="171px" width="180px" className="p-2" radiusSize={true}>
                                <div className='p-5'>
                                    <div className="text-white text-[14px] font-medium mb-2">Add icon</div>
                                    <div className="text-white text-[14px] font-medium mb-2">Tailored protection</div>
                                    <div className="text-white text-[11px] font-medium">Deliver precise security for unique client needs</div>
                                </div>
                            </CardBorder>
                            <CardBorder height="171px" width="180px" className="p-2" radiusSize={true}>
                                <div className='p-5'>
                            ...
                            <CardBorder height="171px" width="180px" className="p-2" radiusSize={true}>
                                <div className='p-5'>
                                    ...
                                    <div className="text-white text-[10px] font-medium">Streamlined delivery by Vijilan's experts</div>
                                </div>
                            </CardBorder>
                        </div>
                    </div>
            ...
            <section className=" relative overflow-hidden pb-16">
                <div className="relative z-10 container mx-auto px-2 sm:px-4 md:px-6 lg:px-8 xl:px-6 py-12">
                    {/* Header */}
                                ...
                                <div className="flex items-start gap-4 mb-6">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-baseline gap-1">
                                            <span className="text-[24px] font-medium text-[#00AEEF]" style={{color: "#00AEEF"}}>{module.price}</span>
            ...
            <section className="container mx-auto sm:px-4 md:px-6 lg:px-8 xl:px-6 pb-16" >
                <div className="rounded-[24px] py-[60px] px10 md:px-[87px]" style={{
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8 p-4">
                        {/* TRX Identity - Endpoint */}
                        <div className=" p-3">
                            <div className="flex justify-between items-center mb-2">
                                <span className="text-white text-[13px]">TRX Identity</span>
                                <span className=" text-[13px]" style={{color: "#00AEEF"}}>$5/endpoint</span>
                            </div>
                            <select className="w-full p-3 rounded-[16px] text-[16px] bg-[#97D0FA3D] focus:bg-[#00AEEF3D] border border-none focus:border-1 focus:outline-none focus:ring-1 focus:ring-[#FFFFFF80] appearance-none">
                                <option value="0" className='text-black' style={{color: "black"}}>0</option>
                                <option value="1" className='text-black' style={{color: "black"}}>1</option>
                                <option value="5" className='text-black' style={{color: "black"}}>5</option>
                                <option value="10" className='text-black' style={{color: "black"}}>10</option>
                                <option value="25" className='text-black' style={{color: "black"}}>25</option>
                                <option value="50" className='text-black' style={{color: "black"}}>50</option>
                            </select>
                        </div>
                        ...
                        <div className=" p-3">
                            <div className="flex justify-between items-center mb-2">
                                <span className="text-white text-[13px]">TRX Identity</span>
                                <span className="text-[#00AEEF] text-[13px]" style={{color: "#00AEEF"}}>$3/user</span>
                            </div>
                            <select className="w-full p-3 rounded-[16px] text-[16px] bg-[#97D0FA3D] focus:bg-[#00AEEF3D] border border-none focus:border-1 focus:outline-none focus:ring-1 focus:ring-[#FFFFFF80] appearance-none">
                                <option value="0" className='text-black' style={{color: "black"}}>0</option>
                                <option value="1" className='text-black' style={{color: "black"}}>1</option>
                        ...
                        <div className=" p-3">
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <span className="text-[#00AEEF] text-[13px]" style={{color: "#00AEEF"}}>$4/endpoint</span>
                            </div>
                            <select className="w-full p-3 rounded-[16px] text-[16px] bg-[#97D0FA3D] focus:bg-[#00AEEF3D] border border-none focus:border-1 focus:outline-none focus:ring-1 focus:ring-[#FFFFFF80] appearance-none">
                                <option value="0" className='text-black' style={{color: "black"}}>0</option>
                                <option value="1" className='text-black' style={{color: "black"}}>1</option>
                        ...
                        <div className=" p-3">
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <span className="text-[#00AEEF] text-[13px]" style={{color: "#00AEEF"}}>$30/server</span>
                            </div>
                            <select className="w-full p-3 rounded-[16px] text-[16px] bg-[#97D0FA3D] focus:bg-[#00AEEF3D] border border-none focus:border-1 focus:outline-none focus:ring-1 focus:ring-[#FFFFFF80] appearance-none">
                                <option value="0" className='text-black' style={{color: "black"}}>0</option>
                                <option value="1" className='text-black' style={{color: "black"}}>1</option>
                        ...
                        <div className="p-3">
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <span className="text-[#00AEEF] text-[13px]" style={{color: "#00AEEF"}}>$99/appliance</span>
                            </div>
                            <select className="w-full p-3 rounded-[16px] text-[16px] bg-[#97D0FA3D] focus:bg-[#00AEEF3D] border border-none focus:border-1 focus:outline-none focus:ring-1 focus:ring-[#FFFFFF80] appearance-none">
                                <option value="0" className='text-black' style={{color: "black"}}>0</option>
                                <option value="1" className='text-black' style={{color: "black"}}>1</option>
                        ...
                        <div className="p-3">
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <span className="text-[#00AEEF] text-[13px]" style={{color: "#00AEEF"}}>$2/user</span>
                            </div>
                            <select className="w-full p-3 rounded-[16px] text-[16px] bg-[#97D0FA3D] focus:bg-[#00AEEF3D] border border-none focus:border-1 focus:outline-none focus:ring-1 focus:ring-[#FFFFFF80] appearance-none">
                                <option value="0" className='text-black' style={{color: "black"}}>0</option>
                                <option value="1" className='text-black' style={{color: "black"}}>1</option>
                  ...
                  <div className='p-5'>
                      <div className="bg-[#97D0FA3D] backdrop-blur-sm rounded-[13px] p-8 text-center">
                        ...
                        <div className="text-[40px] font-bold text-[#00AEEF] mb-6" style={{color: "#00AEEF"}}>0$</div>
                        ...
                        <Link to={"/pricing-tool"} onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
                            <button className=" text-white font-medium p-[18px] md:p-[24px] rounded-lg text-[16px] md:text-[18px] " style={{
                                background: "linear-gradient(90deg, #F89B29 0%, #FF0F7B 186.51%)"
                            }}>
            ...
            <section className='container mx-auto sm:px-4 md:px-6 lg:px-8 xl:px-6 py-16'>
                <div className='mb-12'>
                ...
                <div className=' flex flex-col md:flex-row gap-12'>
                    ...
                    <div className='relative py-[45px] px-[51px] bg-[#00AEEF3D] rounded-[24px]'>
                        ...
                        <div className='text-center'>
                            <div className=" text-[24px] font-medium text-[#00AEEF] uppercase mb-1" style={{color: "#00AEEF"}}>Add icon</div>
                            <p className='text-[24px] font-medium text-[#00A991] mb-1' style={{color: "#00A991"}}>15%</p>
            ...
            <section className="container mx-auto sm:px-4 md:px-6 lg:px-8 xl:px-6 py-16">
                <div className="">
                    <div className=" rounded-3xl py-[50px] px-3 md:px-12 lg:px-[113px]" style={{
                        ...
                        <h1 className="text-white text-[27px] font-bold text-center mb-18">
                            The Vijilan Advantage: Expert-Backed, Partner-Focused
                        </h1>

                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                            {features.map((feature, index) => (
                                <div key={index} className="text-center px-5 md:px-0 text-white">
            ...
            <section className='container mx-auto sm:px-4 md:px-6 lg:px-8 xl:px-6 pb-16'>
                <Heading_Btn
                    ...
                    btn8="DOWNLOAD THREATREMEDIATE ESSENTIALS SOLUTION BRIEF"
                    url={"/pricing-tool"}
                />
            </section>
        </div>
